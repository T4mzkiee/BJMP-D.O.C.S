...
export const Sidebar: React.FC<SidebarProps> = ({ currentPage, user, onNavigate, onLogout }) => {
  ...
  return (
    <div className="w-64 bg-gray-800 h-screen border-r border-gray-700 flex flex-col shadow-sm fixed left-0 top-0">
      ...
      <div className="p-4 border-t border-gray-700">
        <div className="flex items-center space-x-3 mb-6 px-4">
          <img src={user.avatarUrl} alt="Profile" className="w-10 h-10 rounded-full border border-gray-600" />
