...
import { Plus, Search, FileText, MoreHorizontal, Sparkles, History, Trash2, AlertTriangle, X, Archive } from 'lucide-react';
...
export const DocumentsPage: React.FC<DocsProps> = ({ documents, setDocuments, currentUser, users, departments }) => {
  ...
  const statusColor = (status: DocStatus, isReturned: boolean) => {
    ...
    switch (status) {
      ...
      case DocStatus.ARCHIVED: return 'bg-gray-600/50 text-gray-400 border border-gray-500';
